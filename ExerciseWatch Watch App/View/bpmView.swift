...
//    
//    // Circular color as a computed property
//    @State private var circularColor: Color = .green
//    
...
//                        alertType: bpmState,
//                        person: "Anda",
//                        heartRate: Int(heartRateViewModel.heartRateModel.heartRate),
...
//                    updateAlertState(for: newHeartRate)
//                }
//            }
//            
//            if showAlertPopup {
...
//    }
//    
//    // Method to update the alert state
//    private func updateAlertState(for heartRate: Double) {
//        if heartRate >= 100 {
//            bpmState = .alert
//            showAlertPopup = true
//            startHapticFeedback()
...
//        } else {
//            if showAlertPopup {
//                bpmState = .alert // Keep the alert state even if heart rate goes back to normal
//            } else {
//                bpmState = .ok
//                circularColor = .green
//            }
